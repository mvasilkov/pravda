...
var from_city = mkt([
    ...
    "Хабаровска",
    "Южно-Сахалинска",
    maybe("советской ")+maybe("антарктической ", "космической", "овощной")+mkt(["базы", "станции"])+
        maybe(" Дружная-", " Комсомольская-", " Полюс-")+mkt([1, 2, 3, 4])
])
...
var where_politics = mkt([
    ...
    "Урюпинской колонии строгого режима для трудновоспитуемых несовершеннолетних "
])
...
var airport = mkt([
    ...
    "Домодедово",
    "Шереметьево",
    "аэропорту "+mkt(["Внуково", "Хитроу", "Бен-Гурион", "JFK"])
])
...
var object_act_on = mkt([
    ...
    "полное трёхдисковое издание БСЭ на BluRay"
    stuffed_toy
])
